...
function handleOutGoingMessage(e){
    ...
    // Replace dots with real text after another delay
    setTimeout(() => {
        incomingMessage.querySelector(".message-text").classList.remove("thinking-dots");
        incomingMessage.querySelector(".message-text").textContent = userData.message;
    }, 1500);

}, 600);

// the code below shows just dots loading while the one above shows thinking for a split second then replaces it with real text
